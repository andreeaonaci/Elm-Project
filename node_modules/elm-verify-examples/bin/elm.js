...
{
	if (region.ad.H === region.ak.H)
	{
		return 'on line ' + region.ad.H;
	}
	return 'on lines ' + region.ad.H + ' through ' + region.ak.H;
}
...
var $author$project$VerifyExamples$init = function (flags) {
	var _v0 = A2($elm$json$Json$Decode$decodeValue, $author$project$VerifyExamples$decoder, flags);
	if (!_v0.$) {
		var tests = _v0.a;
...
var $author$project$VerifyExamples$subscriptions = function (_v0) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				$author$project$VerifyExamples$generateModuleVerifyExamples(
				function (value) {
					var _v1 = A2($elm$json$Json$Decode$decodeValue, $author$project$VerifyExamples$decodeElmSource, value);
					if (!_v1.$) {
						var a = _v1.a;
				...
				function (value) {
					var _v2 = A2($elm$json$Json$Decode$decodeValue, $author$project$VerifyExamples$decodeMarkdownSource, value);
					if (!_v2.$) {
						var a = _v2.a;
...
var $author$project$VerifyExamples$ModuleName$toString = function (_v0) {
	var name = _v0;
	return name;
};
...
var $author$project$VerifyExamples$Test$specBody = function (_v0) {
	var assertion = _v0.ah;
	var expectation = _v0.am;
	return $author$project$String$Util$unlines(
		_List_fromArray(
...
var $elm$regex$Regex$Match = F4(
	function (match, index, number, submatches) {
		return {a2: index, a4: match, a7: number, bc: submatches};
	});
...
var $author$project$VerifyExamples$Test$exampleDescription = function (_v0) {
	var assertion = _v0.ah;
	var expectation = _v0.am;
	return $author$project$String$Util$unlines(
		_List_fromArray(
...
var $author$project$VerifyExamples$Compiler$toImports = function (_v0) {
	var imports = _v0.Q;
	return $author$project$String$Util$unlines(
		_List_fromArray(
			[
...
var $author$project$VerifyExamples$Function$toString = function (_v0) {
	var _function = _v0.aq;
	return _function;
};
var $author$project$VerifyExamples$Compiler$compileTest = F4(
	function (nomenclature, suite, index, test) {
		var testName = nomenclature.aO(test);
		var testModuleName = A2(nomenclature.aN, index, test);
			...
			$author$project$String$Util$unlines(
				_List_fromArray(
					[
						...
						$author$project$String$Util$unlines(suite.T),
						'',
						$author$project$String$Util$unlines(
						A2($elm$core$List$map, $author$project$VerifyExamples$Function$toString, suite.a$)),
						'',
...
var $author$project$VerifyExamples$ModuleName$extendName = F2(
	function (_v0, extension) {
		var name = _v0;
		return name + ('.' + $author$project$VerifyExamples$ModuleName$toSentenceCase(extension));
	});
var $author$project$VerifyExamples$Test$functionName = function (_v0) {
	var functionToTest = _v0.ar;
...
var $author$project$VerifyExamples$Elm$Nomenclature$testModuleName = F3(
	function (moduleName, index, test) {
		return A2(
			...
			moduleName,
			function () {
				var _v0 = $author$project$VerifyExamples$Test$functionName(test);
				if (!_v0.$) {
					var name = _v0.a;
					return _Utils_ap(
						name,
...
var $author$project$VerifyExamples$Elm$compile = F2(
	function (moduleName, testSuite) {
		return A2(
			...
			{
				aN: $author$project$VerifyExamples$Elm$Nomenclature$testModuleName(moduleName),
				aO: $author$project$VerifyExamples$Elm$Nomenclature$testName
			},
...
var $author$project$VerifyExamples$Warning$Ignored$all = F2(
	function (warning, ignores) {
		var _v0 = A2(
			$elm$core$List$filter,
			function (ignored) {
				return _Utils_eq(ignored.ay, $elm$core$Maybe$Nothing);
			},
			A2(
				$elm$core$List$filter,
				function (_v1) {
...
var $author$project$VerifyExamples$Warning$warnings = F2(
	function (ignored, _v0) {
		var exposedApi = _v0.an;
		var testSuites = _v0.af;
		return A2(
			$elm$core$List$filter,
...
var $author$project$VerifyExamples$compileElm = F2(
	function (_v0, parsed) {
		var moduleName = _v0.Z;
		var fileText = _v0.G;
		var ignoredWarnings = _v0.au;
		var _v1 = parsed.af;
		if (!_v1.b) {
			return _Utils_Tuple2(
				_List_Nil,
...
var $author$project$VerifyExamples$Markdown$testModuleName = F4(
	function (suiteIndex, filePath, fileIndex, _v0) {
		...
		var addIndex = function (components) {
			return A2(
				...
				_List_fromArray(
					[
						'Test_' + ($elm$core$String$fromInt(fileIndex) + ('_' + $elm$core$String$fromInt(suiteIndex)))
					]));
		};
...
var $author$project$VerifyExamples$Markdown$compile = F2(
	function (filePath, _v0) {
		var suiteIndex = _v0.a;
		var suite = _v0.b;
		return A2(
			$author$project$VerifyExamples$Compiler$compile,
			{
				aN: A2($author$project$VerifyExamples$Markdown$testModuleName, suiteIndex, filePath),
				aO: function (test) {
...
var $author$project$VerifyExamples$compileMarkdown = F2(
	function (_v0, parsed) {
		...
		return A2(
			...
			A2($elm$core$List$indexedMap, $elm$core$Tuple$pair, parsed.af));
	});
...
var $author$project$VerifyExamples$Encoder$encodeFile = function (_v0) {
	var name = _v0.a;
	var content = _v0.b;
...
var $author$project$VerifyExamples$Ast$Grouped$empty = {O: _List_Nil, P: _List_Nil, Q: _List_Nil, T: _List_Nil};
					...
					case 2:
						...
						return A2(
							...
							function (x) {
								...
								A2($elm$core$List$cons, str, acc.Q)));
					case 4:
						var str = ast.a.a;
						var rest = ast.b;
						return A2(
							...
							function (x) {
								...
								A2($elm$core$List$cons, str, acc.T)));
					default:
						var _v2 = ast.a;
						var name = _v2.a;
						var str = _v2.b;
...
var $author$project$VerifyExamples$Test$fromExamples = function (functionToTest) {
	return $elm$core$List$map(
		function (_v0) {
			var assertion = _v0.ah;
			var expectation = _v0.am;
			return {ah: assertion, am: expectation, ar: functionToTest};
		});
};
var $author$project$VerifyExamples$Ast$Grouped$importToString = function (_v0) {
	var import_ = _v0;
	return import_;
};
var $author$project$VerifyExamples$Function$Function = $elm$core$Basics$identity;
var $author$project$VerifyExamples$Ast$Grouped$functionInfo = function (_v0) {
	var info = _v0;
	return info;
};
...
var $author$project$VerifyExamples$Function$isUsedInExample = F2(
	function (_v0, _v1) {
		var name = _v0.ay;
		var assertion = _v1.ah;
		var expectation = _v1.am;
...
var $author$project$VerifyExamples$Function$usedFunctions = function (_v0) {
	var used = _v0.a;
	var fns = _v0.b;
	var _v1 = A2(
...
var $author$project$VerifyExamples$Ast$Grouped$typeToString = function (_v0) {
	var type_ = _v0;
	return type_;
};
var $author$project$VerifyExamples$TestSuite$fromAst = F2(
	function (fnName, _v0) {
		...
		var examples = _v0.O;
		return {
			a$: A2($author$project$VerifyExamples$Function$toFunctions, examples, functions),
			Q: A2($elm$core$List$map, $author$project$VerifyExamples$Ast$Grouped$importToString, imports),
			be: A2($author$project$VerifyExamples$Test$fromExamples, fnName, examples),
			T: A2($elm$core$List$map, $author$project$VerifyExamples$Ast$Grouped$typeToString, types)
		};
	});
...
var $author$project$VerifyExamples$Ast$Intermediate$intermediatesToAst = function (_v0) {
	var first = _v0.a;
	var rest = _v0.b;
	return A2(
...
var $author$project$VerifyExamples$Parser$parse = function (_v0) {
	var snippet = _v0.ac;
	var functionName = _v0.W;
	return A2(
...
var $author$project$VerifyExamples$Elm$toTestSuite = function (snip) {
	if (!snip.$) {
		...
		return $author$project$VerifyExamples$Parser$parse(
			{W: $elm$core$Maybe$Nothing, ac: snippet});
	} else {
		var snippet = snip.a.ac;
		var functionName = snip.a.W;
		return $author$project$VerifyExamples$Parser$parse(
			{
				W: $elm$core$Maybe$Just(functionName),
				ac: snippet
			});
	}
};
var $author$project$VerifyExamples$Elm$parse = function (fileText) {
	return {
		an: $author$project$VerifyExamples$Elm$ExposedApi$parse(fileText),
		af: A2(
			$elm$core$List$map,
...
var $author$project$VerifyExamples$Markdown$toTestSuite = function (_v0) {
	var snippet = _v0;
	return $author$project$VerifyExamples$Parser$parse(
		{W: $elm$core$Maybe$Nothing, ac: snippet});
};
...
var $author$project$VerifyExamples$Warning$toString = function (_v0) {
	var type_ = _v0.a;
				...
				return $elm$core$Platform$Cmd$batch(
					_List_fromArray(
						[
							...
							A2($author$project$VerifyExamples$reportWarnings, source.Z, warnings)
						]));
			}(
				A2(
...
var $author$project$VerifyExamples$main = $elm$core$Platform$worker(
	{
		...
		bd: $author$project$VerifyExamples$subscriptions,
		bg: F2(
			function (msg, _v0) {
				return _Utils_Tuple2(
					0,
